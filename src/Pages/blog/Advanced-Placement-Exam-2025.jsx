  ...
  return (
    <>
      ...
      <div className="container  mx-auto p-4  pt-12 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        ...
        <h1 className="text-4xl font-bold pt-12 mb-2 text-gray-900 ">
          {blog.title}
        </h1>
        ...
        <div className="text-gray-700 text-lg leading-relaxed ">
          ...
          <ul className="list-disc list-inside mb-6 pl-5">
            ...
            <li className="mb-3 text-gray-900">
              <strong className="text-gray-900 ">International fee:</strong>{" "}
              $129 (outside U.S. territories and Canada)
            </li>
            <li className="mb-3 text-gray-900">
          ...
          <ul className="list-disc list-inside mb-6 pl-5">
            ...
            <li className="mb-3 text-gray-900">
              <strong className="text-gray-900 ">Review Books</strong>{" "}
          ...
          {blog.id === 2 && (
            <>
              ...
              <ul className="list-disc list-inside mb-6 pl-5">
                ...
                <li className="mb-3">
                  <strong className="text-gray-900 ">Senior Division:</strong>{" "}
                  It includes students aged 15 to 18 years.
                </li>
                <li className="mb-3">
              ...
              <p className="mb-6 text-gray-900 ">
                ...
                flame. Register, train and team up with LITWITS for World
                Scholar's Cup.
              </p>
