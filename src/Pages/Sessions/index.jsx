  ...
  return (
    <section>
      ...
      >
        ...
        <p
          id="individual-sessions-description"
          className="sr-only"
          style={{ fontSize: "15px" }}
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg mx-auto mt-6">
                ...
                <Link
                  to="/membership"
                  className="text-white bg-blue-950  px-6 py-3 no-underline w-full uppercase rounded-md text-base font-medium transition text-center "
                  style={{
                    fontFamily: "Noto Sans",
                  }}
                >
      ...
      <section id="faq" className="container mx-auto px-8 bg-gray-50">
        <div className="container mx-auto ">
          <h2 className="text-2xl font-nato pt-6 font-bold text-center text-red-700 mb-2">
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body className="bg-[#890C25] text-white">
                ...
                <ul className="list-disc pl-5 text-white">
                  <li className=" text-sm font-normal text-white mt-1">
                    TED-Ed Training
                  </li>
                  <li className=" text-sm font-normal text-white mt-1">
                    MUN Guidance Package
                  </li>
                  <li className=" text-sm font-normal text-white mt-1">
