...
const index = () => {
  return (
    <div>
      <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 text-white p-4">
        {/* Animated Header */}
        ...
        {/* Footer Section */}
        <p className="mt-12 text-center">Stay tuned! Follow us for updates.</p>
      </div>
    </div>
  );
};
