    ...
    <>
      ...
      <section>
        ...
        >
          ...
          <p id="group-session-description" className="sr-only">
          ...
          >
            ...
            <div className="relative text-left text-white max-w-4xl px-4">
              ...
              <p className="font-nato text-sm md:text-lg leading-relaxed">
                ...
                in Regional Rounds, Global Rounds, and the finale, the
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Effective Communication is a power skill, not a soft skill.
                  The ability to address an audience authentically and
                  powerfully is the hallmark of impactful leadership.
                </p>
                <br />
                <p className="text-gray-700">
        ...
        <section>
          ...
          >
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="font-nato text-sm sm:text-base md:text-lg leading-5 sm:leading-6 md:leading-7 text-white">
                    ...
                    sessions, students learn the fundamentals of earning,
                    saving, budgeting, and investing in a real and approachable
                    way.
                  </p>
                  <p className="font-nato text-sm sm:text-base md:text-lg leading-5 sm:leading-6 md:leading-7 text-white">
            ...
            {/* Descriptive Content for Accessibility */}
            <p id="financial-literacy-session-description" className="sr-only">
            Practical sessions equipping students with essential money management skills, including budgeting, saving, and investing through hands-on activities.
            </p>
          </div>
        </section>
