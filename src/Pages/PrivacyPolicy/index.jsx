  ...
  return (
    <>
      ...
      <Helmet>
        ...
        />
        <meta name="keywords" content="Privacy policy, Student data protection, Student Privacy Policy" />
        <meta property="og:title" content="LITWITS Privacy Policy: Student Data Protection & Privacy" />
        <meta
    ...
    <div className="font-noto text-gray-800">
      <div className="px-6 py-8 max-w-4xl mx-auto">
        ...
        <p className="text-base mb-6 text-gray-800">
          LITWITS ("we," "us," or "our") is committed to protecting the privacy
          and security of our participants' personal information. This Privacy
        ...
        <p className="text-base mb-4 text-gray-800">
          ...
          non-personal information about your interactions with our website and
          services, such as IP address, browser type, and usage data.
        </p>
        ...
        <p className="text-base mb-4 text-gray-800">
          <strong>2.2 To Improve Services:</strong> We may use non-personal and
          usage data to analyze trends, enhance our website, and improve our
          services.
        </p>
        <p className="text-base mb-6 text-gray-800">
          <strong>2.3 To Send Communications:</strong> We may send you updates,
          newsletters, promotional materials, and other information related to
          LITWITS programs and services. You can opt out of receiving these
        ...
        <p className="text-base mb-4 text-gray-800">
          ...
          personal information with third-party service providers who assist us
          in operating our website, processing payments, and delivering our
        ...
        <p className="text-base mb-6 text-gray-800">
          <strong>3.3 No Sale of Information:</strong> We do not sell, rent, or
        ...
        <p className="text-base mb-6 text-gray-800">
          ...
          in this Privacy Policy, comply with legal obligations, or as otherwise
          required.
        </p>
        ...
        <p className="text-base mb-6 text-gray-800">
          <strong>5.3 Data Deletion:</strong> If you wish to have your personal
          information deleted, please contact us. We will process your request
