    ...
    >
      ...
      <div className="relative flex items-center justify-center h-full px-4 md:px-8 lg:px-16">
        <div className="text-center text-white space-y-3 max-w-5xl mx-auto font-serif py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          <p className=" md:text-l text-white  text-left font-noto"style={{ fontSize: "15px" }}>
          ...
          <p className=" md:text-l text-white  text-left font-noto mt-2"style={{ fontSize: "15px" }}>
      ...
      <p id="partners-educational-journey-description" className="sr-only"style={{ fontSize: "15px" }}>
