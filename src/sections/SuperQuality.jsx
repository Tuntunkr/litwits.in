      ...
      <div className="relative flex items-center justify-center h-full px-4 md:px-8 lg:px-16">
        <div className="text-center text-white space-y-8 max-w-3xl mx-auto font-serif py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          <p className="text-lg md:text-xl text-white  text-left">
            ...
            range of diverse and dynamic opportunities. These include Research
            and Policy Papers, Creative Writing, Debating, Model United Nations,
            TED-Ed Talks, Entrepreneurship, Advanced Placement courses and
            tailored preparation for Ivy League and prestigious academic
            endeavours to foster intellectual rigour and a pursuit of
            excellence.
          </p>
